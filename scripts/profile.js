...
(function () {
  ...
  var myChart2 = new Chart(
    document.getElementById("time_spent_chart"),
    config2
  );
  ...
  function GetInfo() {
    ...
    var text = "Perdorues";
    if (user != null) {
      if (JSON.parse(user).name != null) text = JSON.parse(user).name;
...
function ValidateNewPswd() {
  ...
  ValidationStyling(
    document.getElementById("new_pswd"),
    check,
    "password_error"
  );
...
function ConfirmNewPswd() {
  ...
  ValidationStyling(
    document.getElementById("confirm_new_pswd"),
    check,
    "confirmPwd_error"
  );
...
function ValidateOldPswd() {
  ...
  var check = false;
  if (oldPswd === userPswd) check = true;
  ValidationStyling(
    document.getElementById("existing_pswd"),
    check,
    "existing_pswd_error"
  );
  return check;
